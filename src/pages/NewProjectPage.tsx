  ...
  const handleCreateProject = async () => {
    ...
    try {
      ...
      const projectResponse = await createProject({
        ...
        start_date: projectData.start_date ? new Date(projectData.start_date).toISOString() : undefined,
        end_date: projectData.end_date ? new Date(projectData.end_date).toISOString() : undefined,
        delivery_date: projectData.delivery_date ? new Date(projectData.delivery_date).toISOString() : undefined,
